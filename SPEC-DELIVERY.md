...
- **الخطوة 6**: لم تُبدأ (بقرار المالك).
...
- **قائمة تحتاج تعديلاً، ولماذا**:
  - ملفات التجميد الستة: تكتب `users.wallet_frozen` مباشرةً، والتجميد انتقل إلى المحفظة؛
