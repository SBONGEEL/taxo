...
- وحارسٌ خارجَ البابِ الواحد يعيش أحمرَ ولا يعلم به أحد (قِيس 2026-09-03) → `GUARDS.md`
- وأخضرُ يعتمد ملفَّ حالةٍ غيرَ متعقَّبٍ ليس أخضرَ الشيفرة (قِيس 2026-09-03) → `GUARDS.md`
