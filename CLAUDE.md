...
- تحذيرُ `autoMemoryReclaim` — **قِيس أخيراً بإقلاعٍ بارد** (٢٠٢٦-٠٩-٠٤) → `STATE.md`
- وثلاثةُ شروطٍ لزمت لبلوغ القياس — **يُكتبن لأن الجولة القادمة ستحتاجهنّ** → `STATE.md`
- جولةُ المتصفّح — **على Chrome، وثلاثةُ عطوبٍ لم يمسكها حارس** (٢٠٢٦-٠٩-٠٤) → `STATE.md`
- ⚠ وتكاملُ Docker مع Ubuntu سقط في هذه الجولة — **ولم يُصلَح** → `STATE.md`
- تكاملُ WSL عاد، وعطبُ المحفظة أُصلح — **جولةُ ٢٠٢٦-٠٩-٠٤ الثانية** → `STATE.md`
- التكاملُ خضراءُ بسطرين لا بواحد → `STATE.md`
- ⚠ وأوّلُ قياسٍ بصريٍّ أعطى صفراً — **والسببُ لم يكن عطباً** → `STATE.md`
- وثلاثةُ عطوبٍ كشفها القياسُ البصريّ — **كلُّها في شيفرةٍ خضراء** → `STATE.md`
- وعطبُ `wallet_owner_undecided` أُصلح — **مقيسٌ بالنقض وعلى الشاشة** → `STATE.md`
- وجردُ الحرّاس خارج البابِ الواحد — **صفرُ جديد** → `STATE.md`
...
- الرفعُ إلى الإنتاج — **٤٧ إيداعاً و٨ ترحيلات، والبوّاباتُ الستُّ خضراء** (٢٠٢٦-٠٩-٠٥) → `STATE.md`
- الأنماطُ الأربعةُ صارت موجودةً على `admin.tajora.ly` — **بشهادة العملية الحيّة** → `STATE.md`
- ⚠ نسخةُ الوثائق كانت خضراءَ وهي عمياء — **٣٧ كبتناً بلا نسخة** (قِيس ٢٠٢٦-٠٩-٠٥) → `STATE.md`
- ⚠ بابُ الرفع كان على حافّة حدِّ `ufw` — **والرقمُ مشتقٌّ من حدٍّ صحيح** (قِيس ٢٠٢٦-٠٩-٠٥) → `STATE.md`
- الإرسالُ الجماعيُّ إلى أكثرَ من حساب — **قِيس، وكشف عطباً لغويّاً** (٢٠٢٦-٠٩-٠٥) → `STATE.md`
- والرفعةُ الثانية — **البوّابةُ المُصلَحة قِيست في مسارها الحقيقيّ** (٢٠٢٦-٠٩-٠٥) → `STATE.md`
- موقعُ `taxo.tajora.ly` — **بُني على تصميمٍ مُسلَّم، ووُصل بما كان مبنيّاً** (٢٠٢٦-٠٩-٠٥) → `STATE.md`
- ⚠ لقطاتُ حزمة التصميم مرفوضةٌ كلُّها — **والأرقامُ هي البرهان** (٢٠٢٦-٠٩-٠٥) → `STATE.md`
- والشعارُ مشتقٌّ لا رسميّ — **يُسجَّل بقول المالك** (٢٠٢٦-٠٩-٠٥) → `STATE.md`
- وأين يسكن الموقعُ ولماذا (٢٠٢٦-٠٩-٠٥) → `STATE.md`
- الموقعُ — الخمسةُ التي أمرتَ بها، مقيسةً (٢٠٢٦-٠٩-٠٥، الجولةُ الثانية) → `STATE.md`
