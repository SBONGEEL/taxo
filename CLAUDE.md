...
> ### وأثرٌ لا يُمسح يشهد لتشغيلٍ مضى (قِيس 2026-08-24)
>
> **أختُ «بابٌ يصيح ثم يخرج بصفر»، ومكانُ وقوعها أخطر: جهازُ المطوّر.**
>
...
>
> **وذيلٌ لا يقلّ عنه**: **`bash -n` مرّ على الأمر المكسور** — لأن التعليقَ
> بعد `\` **سليمُ التركيب** وإن ابتلع بقيّةَ الأمر. **ففحصُ التركيب ليس
> قياسَ سلوك**، وهو `tsc --noEmit` نفسُه في ثوب صَدَفة: أداةٌ تجيب عن سؤالٍ
> غير الذي سألتَه، **وسكوتُها يُقرأ جواباً عن سؤالك**.
