...
- وحارسٌ مرجعُه نسخةٌ محلّيةٌ مُهمَلة يصيح على إنتاجٍ سليم (قِيس ٢٠٢٦-٠٩-١١) → `GUARDS.md`
- وبابٌ واحدٌ لتشغيل الرفع على جهاز المطوّر — **قاعدةٌ صارت شرطاً** (٢٠٢٦-٠٩-١١) → `GUARDS.md`
...
- بوّابةُ المعمار تصيح على **ذِكرِ** مسارٍ في بيانات، لا على كتابةٍ فيه (قِيس ٢٠٢٦-٠٩-١٠) → `GUARDS.md`
- النسخةُ الرابعةُ عمياءُ عن المُهمَل — **١٥ ميغا على قرص الإنتاج خارجَ كلِّ نسخة** (قِيس ٢٠٢٦-٠٩-١٠) → `GUARDS.md`
...
- `check:enum-coverage` — **حارسٌ يسأل عن الزائد ولا يسأل عن الناقص يمرّ فوق عشرين بالمئة من دفترٍ يراه المشرف** (قِيس 2026-09-07) → `GUARDS.md`
- ونصُّ زرِّ الملفّ — **بيتان لنصٍّ واحد** (وُحِّد 2026-09-07) → `GUARDS.md`
...
- وشكلان لسؤالٍ واحدٍ ليسا نسختين إذا حمل كلٌّ شرطاً (٢٠٢٦-٠٩-٠٧) → `GUARDS.md`
...
- حارسان لِما يُرى لا لِما يُقرأ — **موضعٌ بلا صورة، ولافتةٌ بلا نصّ** (٢٠٢٦-٠٩-٠٩) → `GUARDS.md`

### `PATTERNS.md` — الأشكال

- الشكلُ الثامنُ والعشرون — **عملٌ يبقى على القرص لأن ما قبل إيداعه لم ينتهِ، فيُقرأ في الجولة التالية «ليس منّي»** (قِيس ٢٠٢٦-٠٩-١٥) → `PATTERNS.md`
...
- الشكلُ السابعَ عشر — **مجلَّدٌ يبدو محلّيّاً وهو سحابة** (قِيس ٢٠٢٦-٠٩-١١) → `PATTERNS.md`
...
- الشكلُ الحادي والعشرون — **ضغطةٌ تصيب غيرَ هدفها فتُشعل دعوى كاذبةً في نموذجٍ قانونيّ** (قِيس ٢٠٢٦-٠٩-٠٩) → `PATTERNS.md`
- الشكلُ العاشرُ مقلوباً — **خادمٌ متأخّرٌ يستر عطباً ساكناً، وأوّلُ بناءٍ يشحنه** (قِيس ٢٠٢٦-٠٩-٠٩) → `PATTERNS.md`
- الشكلُ الثاني والعشرون — **لقطةٌ من بيئةٍ تخالف الإنتاج تَعِد بما لا يقع** (قِيس ٢٠٢٦-٠٩-٠٩) → `PATTERNS.md`
...
- التسجيلُ ميّتٌ على الإنتاج تسعةَ أيام — **والشاهدُ عدُّ الصفوف** (٢٠٢٦-٠٩-٠٩) → `STATE.md`
...
- الشاشتان الرئيسيتان — بلاطاتٌ متقابلةٌ وصندوقٌ بمصدرين (٢٠٢٦-٠٩-٠٧) → `STATE.md`
...
- لافتاتُ الأردن الثلاث على الإنتاج، والصندوقُ يُسحب ويدور — **والإصلاحُ مودَعٌ لم يُرفع** (٢٠٢٦-٠٩-١٩) → `STATE.md`
- سبعُ لافتاتٍ أخرى على الإنتاج، ولا مفتاحَ أُشعل — **والثامنةُ مسوّدةٌ بلا صورة** (٢٠٢٦-٠٩-١٩) → `STATE.md`
- دفعةُ السبع — أربعٌ نُشرت بلا رابط، وثلاثٌ أُمسكت لأنها تَعِد بما لا يعمل (٢٠٢٦-٠٩-١٩) → `STATE.md`
- الثلاثُ المُمسَكة نُشرت بقرار المالك، والمحجوبةُ اكتملت — الراكبُ ١٦ والكبتنُ ٤ (٢٠٢٦-٠٩-١٩) → `STATE.md`
- رفعُ ٢٠٢٦-٠٩-١٩ سقط في الخامسة بعطبٍ في السكربت — **والواجهاتُ حيّةٌ لأن `dist` مُثبَّت** (قِيس) → `STATE.md`
- عطبُ الالتقاط أُصلح في `ssh_try`، والعملياتُ العالقةُ الثلاث أُنهيت (٢٠٢٦-٠٩-١٩) → `STATE.md`
...
- أداتان تعملان على ويندوز والشجرةُ في WSL (٢٠٢٦-٠٩-٠٥) → `COMMANDS.md`
...
<!--جديد-->
| **موضعُ لقطةٍ في صفحة التسويق بلا ملفّ — أو ببطاقةٍ نصُّها «لم تُلتقط»** | **`check:shots`** — يمنع بناءَ الموقع، **ولا يُخفي الفارغَ** (قرارُ المالك ٢٠٢٦-٠٩-٠٩): قسمٌ عنوانُه «خمس محطات» يعرض ثلاثاً **يكذب بالسكوت**. ولا يقيس أن اللقطةَ حديثةٌ ولا صادقةٌ عن الإنتاج — شرطٌ بشريٌّ يبقى |
| **حزمةٌ تُبنى ثمّ يُغيَّر ما تشير إليه** | **`check-apk-target.mjs`** — يقرأ المعرّفَ و`server.url` و`apiBase` **من داخل ملفّ الـAPK قبل التثبيت** ويقارنها بـ`channels.json`. **والتطبيقُ يُصرَّح وسيطاً** وإلا قِيست حزمةُ الكبتن بقناة الراكب |
...
| **مهلتان لعملٍ واحدٍ تفترقان — فتُقتل مجموعةٌ خضراءُ وتُقرأ حمرةً** | **`check:ci-timeouts`** — يمسك **الافتراقَ لا الصِّغَر**، **ولا يحكم أنّ الرقم كافٍ** ويقول ذلك |
...
| **تخطيطٌ يفيض على الهاتف — «رأيتُه بعيني» وصفٌ لا قياس** | **`tools/check-mobile`** — ٤ مقاساتٍ × ١٠ مساراتٍ بالعناصر: فيضٌ · خارجَ الإطار · لمسٌ دون ٤٤ · تقاطعٌ · تحت شريطٍ ثابت · **وأثرُ لوحة المفاتيح**. **ولا يقيس هاتفاً حقيقياً ولا خلايا الجداول التي تُمرَّر**، ويقول ذلك. و`--negate` يقيسه في الاتجاه الآخر |
<!--/جديد-->

<!--جديد-->
### درسٌ واحدٌ لثلاثة أخطاء — **العلامةُ القريبةُ تُقرأ العلامةَ نفسَها** (تسميةُ المالك ٢٠٢٦-٠٩-٠٥)

**ثلاثةُ أخطاءٍ في جولةٍ واحدة، وهي شكلٌ واحدٌ لا ثلاثة:**

| ما قِيس | ما صُدِّق أنه المقيس | الكلفةُ المقيسة |
|---|---|---|
| `localhost:5173` يردّ `200` بتطبيقٍ يعمل | **أنه تطبيقُنا** — وحاويتُنا على `5176`، و`5173` منفذُها **من داخلها** | **٥ لقطاتٍ من خادمٍ أجنبيٍّ على ويندوز**، ولم يكشفها إلا **لونٌ** يقول `ARCHITECTURE.md` إنه زال |
| «الشاشةُ غيرُ فارغة» — نصٌّ وعقدٌ فوق حدٍّ | **أنها الشاشةُ المطلوبة** | **شاشةُ ترحيبٍ واحدةٌ حُفظت خمسَ مرّاتٍ بخمسة أسماء**، وكشفها **تساوي الأرقام**: ٢٥٧ حرفاً و٨٦ عقدةً في الخمس |
| علامةٌ نصّيةٌ ظهرت («المحفظة») | **أن البيانات وصلت** | **دوّارةُ تحميلٍ حُفظت باسم «محفظة»** — والترويسةُ تُرسم قبل أن تصل البيانات |

**والجامعُ بينها واحد: علامةٌ يملكها المطلوبُ وغيرُه — فوجودُها لا يميّز.**
ومن قبلها لم يقِس ما ظنّ أنه يقيس، **وخرج بخُضرةٍ صادقةٍ عن سؤالٍ آخر**.
وهو **جارُ** الشكل الخامسَ عشر («حارسٌ صادقٌ تُوسَّع دعواه») **ويفترق عنه**:
ذاك توسيعُ دعوى حارسٍ صحيح، **وهذا خطأٌ في اختيار العلامة من أوّلها**.

**حارسٌ ممكن؟ نعم — وقد بُني**: `tools/capture-screens/capture.mjs`، **ثلاثةُ
شروطٍ لكلِّ لقطة، وكلُّ واحدٍ منها ثمنُ سطرٍ من الجدول**:

1. **الحزمةُ المخدومةُ تطابق `dist`** — **تُقرأ من `dist/index.html` ولا
   تُكتب في المصدر**: رقمٌ منسوخٌ يبلى عند أوّل بناءٍ **فيصيح على سليم**.
2. **ولكلِّ لقطةٍ علامةٌ تخصّها** — لا مقياسٌ عامٌّ تجتازه كلُّ شاشة.
3. **وزوالُ الدوّارة** (`[role=status]` · `[aria-busy]` · `.animate-spin`).

**وما لا يمسكه مكتوبٌ فيه**: **طولُ النصِّ ليس فيصلاً** — شاشةُ الخريطة ٧٩
حرفاً **وهي مكتملة**، فرفضُها بالطول رفضُ سليم؛ والحدُّ الأدنى للفراغ المحض
وحدَه. **ولا يقيس أن الشاشةَ صحيحةٌ بصرياً**، بل أنها **التي طُلبت وقد
اكتملت** — والبصرُ بعدها شرطٌ بشريّ.
<!--/جديد-->
...
<!--جديد-->
### القراراتُ التقنيّةُ لي — **والأربعةُ للمالك** (قرارُ المالك 2026-09-22)

**ما كان تقنيّاً محضاً يُقرَّر ولا يُسأل عنه**: كيف يُعاد CI، وأيُّ علاجٍ من
متكافئات، والإعادة، وترتيبُ الخطوات التقنيّة — **ويُكتب في التقرير ما اختير
ولمَ**.

**ويُوقَف ويُسأل في أربعةٍ لا غير**: (١) ما يمسّ المالَ أو المحافظَ أو الدفعاتِ
أو الدفتر · (٢) القاعدةُ أو البياناتُ الشخصيّة · (٣) **ما يراه المستخدمون أو
يعيشونه مختلفاً** · (٤) مطلقاتُ هذا الملفّ. **وما لا يملكه غيرُه** — سرٌّ أو
حسابٌ أو إصبعُه على هاتف — يُطلب لأنه لا يُصنع، لا لأنه يُستأذن فيه.
