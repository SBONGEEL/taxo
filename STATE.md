...
### وبندٌ مفتوحٌ لم يُلمس — **مخرَجُ بناءٍ ما زال مُودَعاً**

`landing/index.html` **مُتجاهَلٌ في `.gitignore` (`/landing/*.html`) ومُتتبَّعٌ
في git معاً** — بقيّةُ ما قبل قرار ٢٠٢٦-٠٩-٠٥ («يبنيه الخادمُ كما يبني
الثلاثة، **ولا يُودَع مخرَجُ بناءٍ في الشجرة**»). **والتجاهلُ لا ينزع تتبّعاً
سابقاً**، فالنسخةُ المُودَعةُ تحمل الوعدَ القديم إلى اليوم.

**ولم يُلمس بقصد**: نزعُه من التتبّع يجعل السحبَ يحذف الملفَّ ثمّ يعيده
البناء، **وهو فعلٌ ثانٍ يمسّ سطحَ الرفع في جولةٍ يقف رفعُها أصلاً** — ولو
سقط لَما عُرف أيُّهما السبب. **يُنفَّذ في جولةٍ لا رفعَ فيها.**
