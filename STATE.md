...
### ⚠ وسؤالٌ للمالك في لقطة المحفظة

`rider-wallet` تعرض **رصيداً بالدينار** (`9.223 د.أ` وحركاتٍ بمبالغها) — وهي
شاشةُ التطبيق الحقيقية. **أهذا من «أرقام الأسعار» الممنوعة أم لا؟** الشرطُ
يقول «لا أرقام أسعار اشتراك ولا مبالغ عروض ولا مكافآت»، **ورصيدُ محفظةٍ ليس
سعراً ولا عرضاً** — لكنه رقمُ مالٍ على الصفحة. **يُسأل ولا يُقرَّر.**
<!--/جديد-->
