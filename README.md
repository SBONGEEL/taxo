...
للـ API، **5173** لتطبيق الراكب.) ولتشغيل الواجهة خارج الحاوية: Node 22+.
...
- تطبيق الراكب: <http://localhost:5173>

**المنفذ 5173 ليس اختيارياً**: هو أحد أصول CORS المسموح بها في الخلفية، وعليه
يُبنى عنوان العودة من صفحة الدفع المستضافة (`CARD_RETURN_URL`).
