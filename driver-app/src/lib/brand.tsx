/** السِمة الوردية — `DESIGN.md` §1.1-ب (المرحلة 10-ج).
 *
 * **رمزان لا لوحة**: `--brand` و`--brand-ink` وحدهما يتبدّلان، والتبديلُ صنفٌ
 * واحد (`.pink`) على الجذر. فلا مكوّنَ يحمل شرطاً بين السِمتين، ولا صنفَ
 * يُضاف ويُحذف مع الحالة — ومكوّنٌ كُتب بـ`text-brand` صحيحٌ في الحالين.
 *
