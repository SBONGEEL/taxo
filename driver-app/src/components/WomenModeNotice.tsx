...
export function WomenModeNotice() {
  ...
  return (
    <div
      ...
      className="fixed inset-x-16 bottom-82 z-[80] mx-auto flex w-max max-w-[88%] items-center gap-10 rounded-full bg-accent px-20 py-10 text-12.5 font-bold text-accent-ink shadow-toast"
    >
