 ...
 *
 * **وموضعُه في هذا التطبيق أعلى من نظيره عند الراكب** (قِيس 2026-08-13):
 * بـ`bottom-nav` كان يقع فوق «ابدأ الاستقبال» بالضبط — `elementFromPoint` في
 * منتصف الزرِّ يعيد التوستَ لا الزر، أي أن **الفعلَ الأساسيَّ للكبتن كان
 * محجوباً** حتى تُغلقه. وأسفلُ شاشة الراكب ورقةٌ تُقرأ، وأسفلُ شاشة الكبتن زرٌّ
 * يُضغط — فالفرقُ في المرساة لا في المكوّن.
 *
...
export function WomenModeNotice() {
  ...
  return (
    <div
      ...
      className="fixed inset-x-16 bottom-170 z-[80] mx-auto flex w-max max-w-[88%] items-center gap-10 rounded-full bg-accent px-20 py-10 text-12.5 font-bold text-accent-ink shadow-toast"
    >
