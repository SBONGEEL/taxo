...
// **ورقةُ الأنماط شرطٌ لا زينة** (وقع مقيساً 2026-08-27): بدونها لا يوجد
// `.mapboxgl-marker { position: absolute }`، **فتسقط العلامةُ في التدفّق
// الطبيعيِّ تحت اللوحة** — قِيست عند `y 649` والخريطةُ `y 357–505`، وحاويتُها
// `overflow:hidden` فاختفت. **والخريطةُ نفسُها تُرسم** (اللوحةُ من WebGL لا من
// CSS)، فبدا العطبُ عطبَ صورةٍ لا تصل — والصورةُ كانت تصل `200`.
//
// **وكان هذا الملفَّ الوحيدَ من خمسةِ مكوّناتِ خرائطَ بلا هذا الاستيراد** —
// والأربعةُ الأخرى تعمل، وهو ما جعل العطبَ يبدو خاصّاً بالمعاينة.
