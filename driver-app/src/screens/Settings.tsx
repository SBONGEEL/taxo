...
export function SettingsScreen() {
  ...
  return (
    <div className="scr h-full bg-bg px-16 pb-12 pt-safe">
      ...
      {/* **والنصُّ يسمّي بصمةَ الإصبع بعينها** (تصحيحُ المالك 2026-08-29):
          النصُّ الأول قال «قفلَ الشاشة وبصمةً» — **وقِيس أنه يرسل القارئَ إلى
          ما فعله**: على S21 كان القفلُ مضبوطاً والوجهُ مسجَّلاً **ولم يظهر
          المفتاح**. والسببُ أن **وجهَ سامسونج لا يُتاح لتطبيقات الطرف الثالث**
          رغم أن `dumpsys` يعلنه Class 2 — يفتح الشاشةَ ولا يصادق التطبيقات.
          **وقِيس الفرقُ بجهازين**: Note 20 بقفلٍ وإصبعٍ ⇒ **المفتاح ظهر**
          باسم «الدخول ببصمة الإصبع». */}
      {biometry?.native && !biometry.available ? (
        <section className="mb-12 card p-15">
          ...
          <p className="mt-4 text-11 leading-snug text-muted">فعّل قفل الشاشة وبصمة إصبع في إعدادات جهازك. وبصمة الوجه في أجهزة سامسونج لا تفتح هذه الميزة.</p>
        </section>
      ) : null}
