  ...
  return (
    <Screen title="بياناتي" back="/account" nav>
      <div className="space-y-20">
        ...
        {/* **بريدُه إن أثبته** (قرارُ المالك 2026-08-31) — **يُعرض ولا
            يُحرَّر هنا**: تغييرُ بريدٍ مُثبَتٍ يحتاج إثباتَ الجديد، **وحقلٌ
            يُعدَّل بلا إثباتٍ يُفرِّغ الإثباتَ من معناه** — وهي قاعدةُ الرقم
            نفسُها المكتوبةُ في رأس هذا الملفّ. و`null` تعني لا بريدَ مُثبَت
            فلا يُرسم سطرٌ فارغ. */}
        {user.email ? (
          <div>
            <p className="text-13 text-muted">البريد المُثبَت</p>
            <p dir="ltr" className="mt-2 text-15 text-ink">
              {user.email}
            </p>
          </div>
        ) : null}
