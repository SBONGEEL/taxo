 ...
 *
 * **والخلفيةُ صارت تنشر `skin` هنا أيضاً (2026-08-22)، وهذا المرآةُ تُسقطه
 * عمداً**: قرارُ تطبيق الراكب أن **خريطتَه قبل القبول لا تتغيّر** — فلا شكلَ
 * ولا حقلَ يُستدلّ منه على مركبةِ أحدٍ قبل أن يقبل رحلتَه. **وحقلٌ لا يُقرأ
 * لا يُكتب في مرآة**: مرآةٌ تحمل ما لا يُعرض تُغري بعرضه.
 */
