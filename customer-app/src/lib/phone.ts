...
/** أسماءُ الدول **بلا أعلام**.
 *
 * كان هنا `🇯🇴` و`🇱🇾`، وهما زوجا محارفِ «مؤشِّر إقليمي» يرسمهما النظامُ علماً
 * إن عرفهما و**حرفين عاديين إن لم يعرفهما** — وهو ما وقع فعلاً حين فُتحت شاشةُ
 * التسجيل في متصفح: ظهر «JO الأردن». وهذا وجهُ القرار 19 الآخر: محارفُ النظام
 * تُرسم من خطوطه فتختلف بين جهازٍ وآخر. وتطبيقُ الكبتن واللوحةُ يكتبان الاسمَ
 * وحدَه أصلاً، فصار الثلاثةُ على قولٍ واحد. */
