 ...
 *
 * **والفرقُ بين المقدَّر والفعلي معروضٌ حين يوجد**: الأجرة تُعاد على المسافة
 * الفعلية عند الانحراف الكبير (القسم 5.7)، وسؤالُ «لماذا اختلفت الأجرة عمّا
 * رآه الراكب» يُجاب من هذين الرقمين لا من حسبةٍ يعيدها المشرف.
 */
