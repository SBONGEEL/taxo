 ...
 *
 * **وست مجموعاتٍ في التصميم، وما بُني منها قسمٌ واحد.** فالتبويبات تُرسم كما
 * هي وتُعطَّل ما لم يكن لقسمها شاشة: قائمةٌ تنقر فيها فلا يقع شيء أسوأ من
 * قائمةٍ تقول «قريباً» — والأولى تجعل المستخدم يشك في اللوحة، والثانية تخبره
 * بحالها. وتظهر الشارةُ «قريباً» على المعطّل صراحةً.
 *
...
const GROUPS: {
  ...
  },
  {
    label: "الأشخاص",
    items: [
      { label: "السائقون والوثائق" },
      { label: "الركّاب" },
      { label: "النزاعات والدعم" },
    ],
  },
  {
    label: "المالية",
    items: [
      { label: "المحافظ والسحب" },
