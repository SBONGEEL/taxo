...
export const WALLET_TX_LABEL: Record<WalletTransactionType, string> = {
  ...
  adjustment: "تسوية",
  // **تُسمّى بما يفهمه المشرفُ لا بترجمة المفتاح** (قرارُ المالك 2026-09-07):
  // من يقرأ الدفترَ يسأل «ماذا جرى لهذا المال؟» لا «ما اسمُ العمود؟».
  //
  // **والأزواجُ تُسمّى بجهتها**: البقشيشُ والإلغاءُ والسلفةُ **قيدان متقابلان
  // بين طرفين** — واسمٌ واحدٌ لهما يجعل المشرفَ يقرأ الخصمَ إضافةً.
  tip: "بقشيش مقبوض",
