...
async def transfer(
    ...
    *,
    ...
    """
    # **والحسابُ المحدود لا يحوّل ولا يُحوَّل إليه** (قرارُ المالك 2026-08-31):
    # **الطرفان يُسألان** — مالٌ يذهب إلى حسابٍ برقمٍ لم يُثبَت لا يُعرف لمن
    # يُردّ، **والاثنان معاً هما ما يجعل الحدَّ حدّاً**: حارسٌ على المرسِل
    # وحدَه يُلتفّ عليه بأن يستقبل بدل أن يرسل.
    #
