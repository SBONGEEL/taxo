...
# مدىً أوسع للطلب المجنَّس (المرحلة 10-ج): الكبتنات أقلُّ عدداً وأبعدُ تفرّقاً،
# فسبعةُ كيلومترات تعني «لم نجد كبتناً» لطلبٍ كانت تسعةٌ كافيةً له. والانتظارُ
# الأطول خيارُ من طلبت الخدمة، أما الرفضُ فليس خياراً لأحد
GENDERED_MAX_SEARCH_RADIUS_KM = 10.0
