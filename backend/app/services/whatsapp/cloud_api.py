...
**والواجهةُ الرسمية من ميتا حصراً** (Graph API على `graph.facebook.com`).
ولا مكتبةَ واتساب غير رسمية في هذا المشروع — لا `whatsapp-web.js` ولا
`Baileys` ولا ما يشبههما: تلك تُؤتمت حساباً شخصياً عبر واجهة الويب، وهو مخالفٌ
لشروط واتساب، وعقوبتُه حظرُ الرقم — أي أن يتوقف تسجيلُ المستخدمين الجدد كلهم
في أسوأ لحظة، ومن رقمٍ لا نملك استرجاعه. والكلفةُ الحقيقية ليست الحظرَ بل أنه
يقع **بلا إنذار وبلا مخرجٍ تقني**.
