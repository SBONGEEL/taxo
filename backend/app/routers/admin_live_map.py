...
**وهو البابُ الوحيد الذي بقي على `AdminUser` بعد مصفوفة الصلاحيات** (البند ٥،
§39٫٥) — **بقرارٍ مكتوبٍ لا بسهو**: القسم 13/1 يجعله **لـ`admin` حصراً**، وهو
**المنفذُ الوحيد في المنصة الذي يقرن هويةً بموقع**. **وإدخالُه في المصفوفة
يجعله قابلاً للمنح** لمن ليس مشرفاً — وذاك ما يمنعه القسمُ نفسُه. **فالحصرُ
هنا صفةُ الدور لا صلاحيةٌ تُمنح.**
"""
