...
class PublicPolicyOut(BaseModel):
    ...
    **ولا يُغني أحدُهما عن الآخر**: النشرُ في الجدول يخصّ التطبيقات، والمفتاحُ
    ...
    doc_type: str
    #: **أيُّ تطبيقٍ نصُّه — يُعلَن ولا يُستنتج** (أُضيف ٢٠٢٦-٠٩-٠٧).
    #:
    #: **والعلّةُ وقعت مقيسةً في اليوم نفسِه**: صفحةُ سياسةِ الكبتن خُبزت
    #: بنصِّ الراكب لأن الخادمَ كان على شيفرةٍ تتجاهل `app`، **فالطالبُ سأل
    #: عن الكبتن وأُعطي الراكبَ ولم يعلم**. **وحقلٌ يقول ما أُعطي يجعل
    #: التجاهلَ مرئيّاً** بدل أن يُخبز صامتاً في صفحةٍ قانونية.
    app: str
    version: int
    body_ar: str
