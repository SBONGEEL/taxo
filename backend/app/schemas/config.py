...
class CountryConfigOut(BaseModel):
    ...
    # **أيُعرض بابُ «سجّل ببريدك» في هذا السوق؟** (قرارُ المالك 2026-08-31)
    #
    # **حقلٌ مستقلٌّ لا عضوٌ في `verification_channels`**: تلك قنواتٌ تُثبت
    # **ملكيةَ الرقم**، **والبريدُ يُثبت البريد** — وإدراجُه بينها يجعل شاشةَ
    # التسجيل تعرضه بديلاً عن إثبات الرقم، **فيُنشأ حسابٌ كاملُ الصلاحية برقمٍ
    # لم يملكه أحد**.
    #
