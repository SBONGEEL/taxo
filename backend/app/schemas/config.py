...
class CountryConfigOut(BaseModel):
    ...
    # **حسابُ كليك المستقبِل لهذا السوق** (قرارُ المالك 2026-08-29) — يُنشر
    # ليقرأه التطبيقان **فلا يكتب أحدُهما رقماً من عنده**، وهو بطبيعته معلَنٌ
    # لمن يحوّل. **و`null` تعني «لم يُضبط»**، وعليها تُخفى القناةُ كلُّها:
