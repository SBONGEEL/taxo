...
class TotpDisableRequest(BaseModel):
    """الإطفاءُ **بكلمةِ المرور وعاملٍ حاضرٍ معاً** (قرارُ المالك 2026-08-21).

    **ولماذا اثنان لا واحد**: الإطفاءُ يُنقص الحماية، وجلسةٌ مسروقةٌ مفتوحةٌ على
    شاشةٍ غيرِ مقفلة تكفي لضغطِ زرّ. فيُطلب **ما يعرفه** (كلمةُ المرور) **وما
    يملكه** (رمزٌ حاضر) — وهما العاملان اللذان أُنشئ هذا كلُّه لأجلهما.
    والتسجيلُ لا يشترط كلمةَ مرورٍ لأنه **يزيد** الحماية؛ والاتجاهُ هو الفرق.

    **ورمزُ الاسترداد يبقى مقبولاً بدل الرمز الحاضر**، ولا يُقرأ ذلك تخفيفاً:
    الرموزُ وُجدت **لأجل ضياع الهاتف** بعينه، فمنعُها هنا يجعل من فقد جهازَه
    عاجزاً عن الإطفاء ولو ملك كلَّ شيءٍ آخر — ويرجع البابُ إلى الخادم، وهو ما
    تُوجد هذه الرموزُ لتمنعه. **وكلمةُ المرور مطلوبةٌ في الحالتين.**
    """
