...
class OfferUpdate(BaseModel):
    ...
    #: **الخطّةُ التي يغطّيها — وهي مدّةُ العرض** (قرارُ المالك 2026-08-29).
    #:
    #: **ولمَ لم تكن هنا**: كان `plan_id` في الإنشاء وحدَه، **فمدّةُ العرض
    #: تُختار مرّةً ولا تُبدَّل أبداً** — و«الشهر الأول مجاناً» يصير أسبوعاً
    #: بإنشاء عرضٍ ثانٍ وإطفاءِ الأول، فيبقى في الجدول عرضان بالاسم نفسِه
    #: تقريباً. **وهو بابٌ بلا زرّ في اتجاهٍ واحد**: يُفتح ولا يُعدَّل.
    #:
    #: **و`None` هنا تعني «لم يُرسل»** لا «كلُّ الخطط» — لأن التعديلَ جزئيٌّ
    #: بـ`exclude_unset`. **فنزعُ التخصيص فعلٌ آخرُ لا يقع بالسهو.**
    plan_id: uuid.UUID | None = None
