...
const DELIBERATE = {
  ...
  // **وانتقل السطرُ مرّتين في يومٍ واحد** (2026-09-03): 1000 → 1001 بوصل
  // `DurationField`، ثمّ → 1008 بجملة العمولة (§39٫١٢٫٥). **والحسابُ نفسُه لم
  // يُمسّ حرفاً في المرّتين** — رُوجع وبقيت علّتُه.
  //
  // **وهذا هو المفتاحُ الحاملُ للسطر يعمل كما صُمّم**: أظهر الفجوةَ مرّتين
  // فرُوجعت مرّتين، **ولم تختبئ تحت عذرٍ كُتب لغيرها**.
  "admin-panel/src/screens/Settings.tsx:1008":
