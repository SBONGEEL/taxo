...
const DELIBERATE = {
  ...
  // **وانتقل السطرُ من 1000 إلى 1001** (2026-09-03، وصلُ `DurationField` أضاف
  // سطرَ استيراد): **والحسابُ نفسُه لم يُمسّ حرفاً** — رُوجع وبقيت علّتُه.
  // **وهذا هو المفتاحُ الحاملُ للسطر يعمل**: أظهر الفجوةَ فرُوجعت.
  "admin-panel/src/screens/Settings.tsx:1001":
